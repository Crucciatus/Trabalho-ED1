...
int main(void) {
  ...
  Student student3 = listStudent_getStudentByRegistry(listStudent, 1);

  listStudent_remove(listStudent, student1);
  listStudent_remove(listStudent, student2);
  listStudent_remove(listStudent, student3);
